namespace tokenisasi\Stemmer;

use tokenisasi\Dictionary\DictionaryInterface;
use tokenisasi\Stemmer\Context\Context;
use tokenisasi\Stemmer\Context\Visitor\VisitorProvider;
...
class Stemmer implements StemmerInterface
{
     ...
     *
     * @var \Tokenisasi\Dictionary\DictionaryInterface
     */
     ...
     * Visitor provider
     *
     * @var \Tokenisasi\Stemmer\Context\Visitor\VisitorProvider
     */
